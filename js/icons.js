...
const Icons = (() => {
  ...
  const apps = {
    ...
    intro: s => svg(`<circle cx="24" cy="24" r="20" fill="#1e3a8a"/><path d="M24 30v-2c0-3 4-3.5 4-7a4 4 0 1 0-8 0" fill="none" stroke="#fff" stroke-width="3.2" stroke-linecap="round"/><circle cx="24" cy="36" r="2.4" fill="#fff"/>`, s),
    firmaportal: s => svg(`<rect x="6" y="12" width="36" height="30" rx="3" fill="#1f6fb2"/><rect x="6" y="12" width="36" height="7" fill="#17568c"/><path d="M14 12V9a10 10 0 0 1 20 0v3" fill="none" stroke="#17568c" stroke-width="3"/><g fill="#fff"><rect x="12" y="24" width="7" height="7" rx="1"/><rect x="22" y="24" width="7" height="7" rx="1"/><rect x="32" y="24" width="4" height="7" rx="1"/><rect x="12" y="34" width="7" height="4" rx="1"/><rect x="22" y="34" width="14" height="4" rx="1"/></g>`, s),
    notater: s => svg(`<rect x="7" y="5" width="34" height="38" rx="4" fill="#7719aa"/><rect x="13" y="5" width="28" height="38" rx="4" fill="#fff" stroke="#c9c9c9"/><rect x="34" y="5" width="7" height="12" fill="#c239b3"/><rect x="34" y="17" width="7" height="12" fill="#e3008c"/><rect x="34" y="29" width="7" height="14" fill="#0078d4"/><path d="M18 15h12M18 21h12M18 27h8" stroke="#9aa4b2" stroke-width="2"/>`, s),
    epost: s => svg(`<rect x="4" y="10" width="40" height="28" rx="4" fill="#0364b8"/><path d="M4 14l20 13 20-13" fill="none" stroke="#fff" stroke-width="2.5"/><path d="M4 36l14-11M44 36l-14-11" stroke="#fff" stroke-width="2" opacity=".6"/>`, s),
    skrivetrening: s => svg(`<rect x="3" y="13" width="42" height="24" rx="4" fill="#374151"/><g fill="#e5e7eb"><rect x="7" y="17" width="5" height="5" rx="1"/><rect x="14" y="17" width="5" height="5" rx="1"/><rect x="21" y="17" width="5" height="5" rx="1"/><rect x="28" y="17" width="5" height="5" rx="1"/><rect x="35" y="17" width="6" height="5" rx="1"/><rect x="7" y="24" width="5" height="5" rx="1"/><rect x="14" y="24" width="5" height="5" rx="1" fill="#fbbf24"/><rect x="21" y="24" width="5" height="5" rx="1"/><rect x="28" y="24" width="5" height="5" rx="1" fill="#fbbf24"/><rect x="35" y="24" width="6" height="5" rx="1"/><rect x="12" y="31" width="24" height="5" rx="1"/></g>`, s),
